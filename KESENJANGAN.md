...
| 5 | Rekrutmen — landing page & portal karier publik | ✅ | Halaman utama publik di akar domain ditujukan untuk calon pelamar, bukan memperkenalkan aplikasinya: ajakan berkarier, lowongan yang sedang dibuka, gambaran cara kerja perusahaan sehari-hari, tahap seleksi, berkas yang perlu disiapkan, tanya jawab, dan peringatan anti-penipuan — seluruhnya dirender server. SEO lengkap: metadata per halaman, Open Graph/Twitter, kanonik, robots.txt, sitemap.xml dinamis, serta data terstruktur Organization/WebSite/FAQPage dan JobPosting per lowongan (syarat tampil di Google Jobs). Calon karyawan punya akun sendiri (email + kata sandi, tabel CandidateAccount terpisah dari Employee) dengan dashboard: melamar mandiri, unggah CV sekali pakai ulang, memantau tahap seleksi beserta tanggalnya, jadwal wawancara, dan mengerjakan tes CBT dari dalam portal. Token pelamar tidak bisa membuka satu pun rute internal dan sebaliknya; hasil tes, skor wawancara, catatan penilai, dan alasan penolakan tidak pernah dikirim ke pelamar. Jalur tulis publik dijaga batas laju per IP, umpan perangkap, dan larangan lamaran ganda. |
